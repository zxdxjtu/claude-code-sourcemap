      ...
      if (0 !== (completedWork.mode & 2)) {
        for (
          ...
          (newChildLanes |= child$107.lanes | child$107.childLanes),
            (subtreeFlags |= child$107.subtreeFlags & 133169152),
            (subtreeFlags |= child$107.flags & 133169152),
        ...
        for (
          ...
          (newChildLanes |=
            ...
            (subtreeFlags |= treeBaseDuration$106.subtreeFlags & 133169152),
            (subtreeFlags |= treeBaseDuration$106.flags & 133169152),
    ...
    switch (finishedWork.tag) {
      ...
      case 1:
        ...
        flags & 64 &&
          ...
          null !== root &&
            ((current = root.callbacks),
            null !== current &&
              ((lanes = root.shared.hiddenCallbacks),
              (root.shared.hiddenCallbacks =
                null === lanes ? current : lanes.concat(current)))));
        break;
      case 26:
        if (supportsResources) {
      ...
      case 3:
        ...
        if (flags & 4) {
          ...
          if (supportsPersistence) {
            ...
            try {
              replaceContainerChildren(current, lanes),
                (viewTransitionMutationContext = !0);
            } catch (error) {
              captureCommitPhaseError(finishedWork, finishedWork.return, error);
            }
      ...
      case 4:
        ...
        viewTransitionMutationContext = hoistableRoot;
  ...
  function prepareFreshStack(root, lanes) {
    ...
    if (0 !== (lanes & 127)) {
      ...
      endTime =
        0 <= blockingEventTime && blockingEventTime < blockingClampTime
          ? blockingClampTime
          : blockingEventTime;
      var clampedRenderStartTime$202 =
        0 <= endTime
          ? endTime
      ...
      0 <= blockingSuspendedTime
        ? (setCurrentTrackFromLanes(2),
          logSuspendedWithDelayPhase(
            ...
            clampedRenderStartTime$202,
            lanes
          ))
        : 0 !== (animatingLanes & 127) &&
          (setCurrentTrackFromLanes(2),
          logAnimatingPhase(blockingClampTime, clampedRenderStartTime$202));
      clampedRenderStartTime$202 = blockingEventType;
      ...
      supportsUserTiming &&
        ...
        0 < endTime
          ? endTime > previousRenderStartTime &&
            (endTime = previousRenderStartTime)
          : (endTime = previousRenderStartTime),
        null !== clampedRenderStartTime$202 &&
          previousRenderStartTime > endTime &&
          console.timeStamp(
            eventIsRepeat
              ? "Consecutive"
              : "Event: " + clampedRenderStartTime$202,
            endTime,
            previousRenderStartTime,
            currentTrack,
            "Scheduler \u269b",
    ...
    0 !== (lanes & 4194048) &&
      ...
      supportsUserTiming &&
        ...
        0 < previousRenderStartTime
          ...
          : (previousRenderStartTime = endTime),
        0 < clampedRenderStartTime$202
          ? clampedRenderStartTime$202 > previousRenderStartTime &&
            (clampedRenderStartTime$202 = previousRenderStartTime)
          : (clampedRenderStartTime$202 = previousRenderStartTime),
        previousRenderStartTime > clampedRenderStartTime$202 &&
          null !== eventIsRepeat &&
          console.timeStamp(
    ...
    if (0 !== endTime)
      for (root = root.entanglements, endTime &= lanes; 0 < endTime; )
        (clampedRenderStartTime$202 = 31 - clz32(endTime)),
          (eventIsRepeat = 1 << clampedRenderStartTime$202),
          (lanes |= root[clampedRenderStartTime$202]),
